...
class UtilTestCase(unittest.TestCase):
    def test_newton_method_1(self):
        ...
        found_tle,_=dsgp4.newton_method(tle_0=my_tle, time_mjd=kessler.util.from_datetime_to_mjd(my_tle._epoch))
        ...
        time_mjd_0=kessler.util.from_datetime_to_mjd(my_tle._epoch)
        ...
        found_state=dsgp4.sgp4(found_tle_2,torch.tensor((time_mjd-kessler.util.from_datetime_to_mjd(found_tle_2._epoch))*1440.))#(kessler.util.from_datetime_to_mjd(found_tle_2._epoch)-kessler.util.from_datetime_to_mjd(new_date))*1440.*torch.ones(1,1,requires_grad=True))
