...
class UtilTestCase(unittest.TestCase):
    def test_newton_method_1(self):
        ...
        found_tle,_=dsgp4.newton_method(tle0=my_tle, time_mjd=dsgp4.util.from_datetime_to_mjd(my_tle._epoch))
        ...
        found_tle_2,_=dsgp4.newton_method(tle0=my_tle, time_mjd=time_mjd, new_tol=new_tol, target_state=target_state)
